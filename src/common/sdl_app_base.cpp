...
bool SDLAppBase::showOverwriteSensitiveDataConfirmDialog() {
    ConfirmDialogConfig config;
    config.message1 = "Natures are generated by the PID (which will change).";
    config.message2 = "This Pokémon might be flagged as hacked.";
    config.yesText = "CONTINUE (Y)";
